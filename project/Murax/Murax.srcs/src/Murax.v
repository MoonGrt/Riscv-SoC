...
module Murax (
    ...
    assign system_mainBusDecoder_logic_hits_1 = ((system_mainBusDecoder_logic_masterPipelined_cmd_payload_address & (~ 32'h00ffffff)) == 32'hf0000000);
    always @(*) begin
    ...
    assign system_mainBusDecoder_logic_hits_2 = ((system_mainBusDecoder_logic_masterPipelined_cmd_payload_address & (~ 32'h00ffffff)) == 32'hf1000000);
    always @(*) begin

...
create_generated_clock -name clk_x1 -source [get_nets {memory_clk}] -master_clock mem_clk -divide_by 4 -multiply_by 1 [get_pins {AHBDMA/u_ddr3/gw3_top/u_ddr_phy_top/fclkdiv/CLKOUT}]

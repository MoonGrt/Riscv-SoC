...
HD_PWD='F:/Project/Sipeed/Tang_Primer/Riscv-SoC/Project/Vivado/Cyber.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Cyber.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Cyber.tcl
